...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_or9rjyr', 'template_r2g7c4b', form.current, '1sJbUHdrtX0oyaW-v')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">itsashusagar@gmail.com</span>
                        
                        <a href="mailto:itsashusagar@gmail.com" className="contact__button">
                            Write Me{" "} 
                ...
                <div className="contact__info">
                    <div className="contact__card">
                       <BsWhatsapp className="contact__card-icon"/>
                        ...
                        <span className="contact__card-data">7827478133</span>
                        
                        <a href="https://api.whatsapp.com/send?phone=7827478133&text=Hello,
                        more information!" className="contact__button">
                            Message Me{" "} 
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
